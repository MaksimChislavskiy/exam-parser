...
Условия задач записываются в Excel как HTML-абзацы `<p>...</p>`. Подпункты
`а)`, `б)` и следующие подпункты одной задачи сохраняются в отдельных абзацах,
чтобы при импорте на сайт их текст не сливался в одну строку.
